...
barplot(as.matrix(t(txAhm)),col=cBp[1:ncol(txAhm)], border=F, space=.04, xlab="Frequency", cex.axis=1.2, cex.lab=1.2, hori=T, las=1, xlim=c(0,ceiling(max(apply(txAhm,1,sum))/10+1)*10))
